  ...
  return (
    <div className='w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100'>
      ...
      <form className='flex flex-col items-stretch gap-4 w-full max-w-[400px] mt-10' >
        ...
        <Button type='submit' className='mt-4'>Entrar na pataforma</Button>
      </form>
      <footer className='flex flex-col items-center gap-4 mt-8'>
        ...
        <Text asChild size='sm'>
          <a href='' className='text-gray-400 underline hover:text-gray-200'>Não poosui conta? Crie uma agora!</a>
        </Text>
      </footer>
    </div>
  )
